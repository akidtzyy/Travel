...
const dbTranslations: Record<string, string> = {
  ...
  'Bliyan 4h3m': 'Bliyan 4D3N',
  'Blide 4h3m': 'Blide 4D3N',
  'Bliman 4h3m': 'Bliman 4D3N',
  ...
  'Paket liburan hemat Bali 4 Hari 3 Malam dengan mengunjungi destinasi favorit Kuta, Pandawa, Kintamani, Penglipuran, dan menikmati Seafood Jimbaran tepi pantai.': 'Bali budget vacation package 4 Days 3 Nights visiting favorite destinations Kuta, Pandawa, Kintamani, Penglipuran, and enjoying beachfront Jimbaran Seafood.',
  'Paket liburan lengkap Bali 4 Hari 3 Malam dengan mengunjungi Bedugul, Kintamani, Penglipuran, Sangeh Hutan Monyet, Tanah Lot, dan menikmati Ayam Betutu Bu Mira.': 'Bali complete vacation package 4 Days 3 Nights visiting Bedugul, Kintamani, Penglipuran, Sangeh Monkey Forest, Tanah Lot, and enjoying Ayam Betutu Bu Mira.',
  'Paket liburan premium Bali East Coast & Temple 4 Hari 3 Malam dengan mengunjungi Lempuyang (Pintu Surga), Tirta Gangga, Taman Ujung, Bedugul, Kintamani, dan banyak lagi.': 'Bali premium vacation package East Coast & Temple 4 Days 3 Nights visiting Lempuyang (Gate of Heaven), Tirta Gangga, Taman Ujung, Bedugul, Kintamani, and more.',
  ...
  'Tanjung Cancel': 'Tanjung Benoa (Optional)',
  ...
  // New Highlights, Activities, Hotels & Specific translations
  'Penjemputan': 'Airport Pick-up',
  'Kalungan bunga': 'Welcome Flower Garland',
  'Sarapan': 'Breakfast',
  'Tanjung benoa optional': 'Tanjung Benoa Watersport (Optional)',
  'Makan siang bu oki': 'Lunch at Bu Oki (Balinese Nasi Campur)',
  'Pandawa': 'Pandawa Beach',
  'Tanah barak': 'Tanah Barak Cliff',
  'Krisna': 'Krisna Souvenirs',
  'Makan malam seafood jimbaran tepi pantai/aroma jimbaran': 'Jimbaran Beach Seafood Dinner (Aroma Jimbaran / Beachfront)',
  'Makan siang grand puncak sari rest': 'Lunch at Grand Puncak Sari Restaurant (Buffet)',
  'Uma ceking rice terrace': 'Uma Ceking Rice Terrace',
  'Jungle gold chocolate': 'Jungle Gold Chocolate',
  'Makan malam shyera rest': 'Dinner at Shyera Restaurant',
  ...
  'Makan malam seafood jimbaram tepi pantai/aroma cafe': 'Jimbaran Beach Seafood Dinner (Aroma Cafe / Beachfront)',
  'Makan siang shyera rest': 'Lunch at Shyera Restaurant',
  'Sangeh  hutan monyet': 'Sangeh Monkey Forest',
  'Makan siang ulundanu rest': 'Lunch at Ulun Danu Restaurant',
  'Makan malam. Ayam betutu bu mira': 'Dinner at Ayam Betutu Bu Mira',
  'Drop airport': 'Airport Drop-off',
  'Lempuyang': 'Pura Lempuyang (Gate of Heaven)',
  ...
  'J4 / Sense Sunset': 'J4 / Sense Sunset',
  'J Kuta': 'J Kuta',
  'Swissbell Express / Fame Kuta': 'Swissbell Express / Fame Kuta',
  'J4 Legian': 'J4 Legian',
  'Swissbell Express': 'Swissbell Express',
